    ...
    const socialItems = [
        {
            id: 'instagram',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 551.034 551.034" width="48" height="48">
                    <defs>
        ...
        },
        {
            id: 'github',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 98 96">
                                    ...
                                    <div className="flex flex-wrap gap-8 sm:gap-6 md:gap-8 lg:gap-10 items-center">
                                        {socialItems.map((social) => (
                                            <a
                                                ...
                                                className={`flex flex-col items-center transition-all duration-300 ${hoveredSocial && hoveredSocial !== social.id
                                                    ? 'opacity-50 scale-95'
